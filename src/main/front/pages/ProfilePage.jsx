...
import { getAllOrders, getUserByToken, getEmployeeByUserId } from '../api/api';
                        ...
                        {orders.length > 0 ? (
                            <div className={styles.ordersGrid}>
                                {orders.map((order) => (
                                    ...
                                    >
                                        <img
                                            src={order.image || 'https://via.placeholder.com/200x120'}
                                            alt="Изображение проекта"
                                            className={styles.orderImage}
                                        />
                                        <h3 className={styles.orderTitle}>{order.title || 'Без названия'}</h3>
                                        <p className={styles.orderStatus}>
                                            Статус: <strong>{order.status || 'Не указан'}</strong>
                                        </p>
                                    </div>
                                ))}
                            </div>
